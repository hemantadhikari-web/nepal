...
# SilwalTape2016 example event (Anchorage) -- python run_getwaveform.py event_input 0
    if iex == 0:
        ...
        ev_info.otime = obspy.UTCDateTime("2017-12-06T15:19:49.000")
        ev_info.min_dist = 0
        ...
        ev_info.network = 'AM,EM,NK,NQ,XF,XN,XQ,Y2,YL,YT,ZO,AK,AT,AV,CN,II,IU,US,XM,TA,XE,XR,XZ,YV,XV,ZE,XG'

        ev_info.channel = 'BH?'
        ev_info.use_catalog = 0
        ev_info.elat = 27.87555
        ev_info.elon = 85.92727
        ev_info.edep = 27100.0
...
# Alaska data from far away event
    if iex == 4:
        ...
        ev_info.otime = obspy.UTCDateTime("2007-07-22T23:02:15.000")
        ev_info.elat = 26.1949
        ev_info.elon = 73.7346
        ev_info.edep = 271000.0
        ev_info.emag = 5
        ev_info.rtime = obspy.UTCDateTime("2007-07-22T23:02:20.000")
        # center at F3TN
        ev_info.rlat = 34.0970
        ev_info.rlon = 86.2041
        ev_info.min_dist = 0
        ev_info.max_dist = 150
        ev_info.tbefore_sec = 100
        ev_info.tafter_sec = 400
        ev_info.network = 'AM,EM,NK,NQ,XF,XN,XQ,Y2,YL,YT,ZO,AK,AT,AV,CN,II,IU,US,XM,TA,XE,XR,XZ,YV,XV,ZE,XG' # no CN,AV,YV,ZE
        ev_info.channel = 'BH?,HH?'
...
# Manley earthquake (Kyle)
    if iex == 8:
        ev_info.use_catalog=0
        ev_info.otime = obspy.UTCDateTime("2005-12-14T07:09:53.000")
        ev_info.elat = 29.6265
        ev_info.elon = 88.7289
        ev_info.edep = 174000.0
        ev_info.emag = 5.6
        ev_info.rtime = ev_info.otime
